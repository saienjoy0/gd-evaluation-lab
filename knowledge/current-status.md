...
- [phase] Exercise A 4状態マトリクスの完成確認
...
- [next] Exercise Aのhigh / medium / low / system_failureを横断する4状態マトリクスを確定する
- [next] 演習B・Cへ共通runnerを展開し、残りの完全Episodeを作成する
...
- informed_by [[Exercise A System Failure Separation v0.1 Decision]]
